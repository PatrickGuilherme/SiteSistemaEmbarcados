...
export default function App() {
  ...
  return (
    <>
      ...
      >
        <p>Algumas das principais características que permeiam os sistemas embarcados são que estes interagem com o ambiente que os cerca:</p>
        
        <ul style={{listStyle:'none', padding:'2%'}}>
          <li style={{paddingBottom:'1%'}}> 
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FF62B0" class="bi bi-phone-fill" viewBox="0 0 16 16">
          ...
          <li style={{paddingBottom:'1%'}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#9A03FE" class="bi bi-battery-charging" viewBox="0 0 16 16">
              <path d="M9.585 2.568a.5.5 0 0 1 .226.58L8.677 6.832h1.99a.5.5 0 0 1 .364.843l-5.334 5.667a.5.5 0 0 1-.842-.49L5.99 9.167H4a.5.5 0 0 1-.364-.843l5.333-5.667a.5.5 0 0 1 .616-.09z"/>
              <path d="M2 4h4.332l-.94 1H2a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h2.38l-.308 1H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"/>
              <path d="M2 6h2.45L2.908 7.639A1.5 1.5 0 0 0 3.313 10H2V6zm8.595-2-.308 1H12a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1H9.276l-.942 1H12a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-1.405z"/>
              <path d="M12 10h-1.783l1.542-1.639c.097-.103.178-.218.241-.34V10zm0-3.354V6h-.646a1.5 1.5 0 0 1 .646.646zM16 8a1.5 1.5 0 0 1-1.5 1.5v-3A1.5 1.5 0 0 1 16 8z"/>
            </svg>
            <span>Consumo energético deste deve ser mínimo e bem balanceado</span>
          </li>

          <li style={{paddingBottom:'1%'}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#03EBA6" class="bi bi-sd-card-fill" viewBox="0 0 16 16">
            ...
            <span>A disponibilidade de memória é muito limitada então um código fonte bem otimizado e enxuto é necessário</span>
          </li>
          
          <li style={{paddingBottom:'1%'}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#2DC800" class="bi bi-motherboard-fill" viewBox="0 0 16 16">
            ...
            <span>Recursos de hardware são bem limitados com a frequência do clock e tensão sendo as menores possíveis</span>
          </li>
          
          <li style={{paddingBottom:'1%'}}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#6A6AFF" class="bi bi-cpu-fill" viewBox="0 0 16 16">
              <path d="M6.5 6a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5h-3z"/>
              <path d="M5.5.5a.5.5 0 0 0-1 0V2A2.5 2.5 0 0 0 2 4.5H.5a.5.5 0 0 0 0 1H2v1H.5a.5.5 0 0 0 0 1H2v1H.5a.5.5 0 0 0 0 1H2v1H.5a.5.5 0 0 0 0 1H2A2.5 2.5 0 0 0 4.5 14v1.5a.5.5 0 0 0 1 0V14h1v1.5a.5.5 0 0 0 1 0V14h1v1.5a.5.5 0 0 0 1 0V14h1v1.5a.5.5 0 0 0 1 0V14a2.5 2.5 0 0 0 2.5-2.5h1.5a.5.5 0 0 0 0-1H14v-1h1.5a.5.5 0 0 0 0-1H14v-1h1.5a.5.5 0 0 0 0-1H14v-1h1.5a.5.5 0 0 0 0-1H14A2.5 2.5 0 0 0 11.5 2V.5a.5.5 0 0 0-1 0V2h-1V.5a.5.5 0 0 0-1 0V2h-1V.5a.5.5 0 0 0-1 0V2h-1V.5zm1 4.5h3A1.5 1.5 0 0 1 11 6.5v3A1.5 1.5 0 0 1 9.5 11h-3A1.5 1.5 0 0 1 5 9.5v-3A1.5 1.5 0 0 1 6.5 5z"/>
            </svg>
            <span>O uso eficiente do hardware pode vir a reduzir o custo final do sistema embarcado</span>
          </li>
        </ul>
      </Modal>
      ...
      <section>
        ...
        <IntroductionSection>
          <IntroductionConcept>
            <h1>Introdução</h1><p style={{textAlign: 'justify'}}>Diferindo dos computadores que possuem sistemas
            ...
            desempenho de uma função específica.</p>
          </IntroductionConcept>
        ...
        <ApplicabilitySection>
          ...
          >
            {mercado.map((mercado, index) => {
              return (
                <SwiperSlide key={index}  style={{background: 'url('+ mercado.img +')',}} >
                  <div style={{display:'flex', alignItems: 'center', justifyContent: 'center', padding: '5% 20% 5% 20%'}}>
                    <p style={{color: mercado.color}}>{mercado.description}</p>
                  </div>
